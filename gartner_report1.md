...
* bulk/batch - ETL
* В 2019 году "претенденты" добились значительных успехов в понимании того, что подготовка данных для самообслуживания, репликация данных, интеграция в облако и виртуализация данных больше не являются отличительными чертами, а должны обладать возможностями в рамках более широкого решения по интеграции метаданных
